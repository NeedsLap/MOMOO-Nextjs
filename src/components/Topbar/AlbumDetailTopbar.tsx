...
import StyledTopbar, { StyledAddPhotoBtn } from '@/components/Topbar/StyledTopbar';

import AlbumDetailTopbapProps from '@/components/Topbar/model';

export default function AlbumDetailTopBar({ tit, openUploadModal }: AlbumDetailTopbapProps) {
  ...
  return (
    <StyledTopbar>
      ...
      <StyledAddPhotoBtn type="button" aria-label="사진 추가하기" onClick={openUploadModal}>
