...
function KakaoMap({ onAddressSelect }: { onAddressSelect: (address: string) => void }) {
      ...
      <MapContainer>
        <SearchHead>
          ...
          <button
            ...
            onClick={() =>
              onAddressSelect(searchedLocation?.place_name ? searchedLocation.place_name : '')
            }
          >
            확인
          </button>
